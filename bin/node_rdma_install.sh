...
# for OFED
wget http://www.mellanox.com/downloads/ofed/MLNX_OFED-4.1-1.0.2.0/MLNX_OFED_LINUX-4.1-1.0.2.0-ubuntu16.04-x86_64.tgz
tar xfz ./MLNX_OFED_LINUX-4.1-1.0.2.0-ubuntu16.04-x86_64.tgz
sudo ./MLNX_OFED_LINUX-4.1-1.0.2.0-ubuntu16.04-x86_64/mlnxofedinstall --all --force
